...
- [ADR-014: Go Concurrency Patterns](/adr/adr-014) - **Accepted**
  - Fork-join concurrency model with worker pools
  - Context-based cancellation
  - Channel patterns for communication

- [ADR-015: Go Testing Strategy](/adr/adr-015) - **Accepted**
  - Three-tier testing (unit, integration, E2E)
  - 80%+ code coverage requirement
  - Proxy integration test harness

- [ADR-016: Go CLI and Configuration Management](/adr/adr-016) - **Accepted**
  - Cobra for CLI framework
  - Viper for configuration management
  - Layered configuration (flags > env > file > defaults)

- [ADR-017: Go Structured Logging with slog](/adr/adr-017) - **Accepted**
...
- [ADR-018: Rust Error Handling Strategy](/adr/adr-018) - **Accepted**
  - thiserror for domain errors, anyhow for application code
  - Error context propagation
  - Type-safe error conversion

- [ADR-019: Rust Async Concurrency Patterns](/adr/adr-019) - **Accepted**
  - Tokio async runtime with work-stealing scheduler
  - Task spawning, channels, and select patterns
  - Connection pooling with sqlx

- [ADR-020: Rust Testing Strategy](/adr/adr-020) - **Accepted**
  - Three-tier testing with async support
  - Property-based testing with proptest
  - Criterion benchmarks

- [ADR-021: Rust Structured Logging with Tracing](/adr/adr-021) - **Accepted**
...
- [ADR-022: Dynamic Client Configuration System](/adr/adr-022) - **Accepted**
...
- [ADR-023: gRPC-First Interface Design](/adr/adr-023) - **Accepted**
...
- [ADR-024: Layered Interface Hierarchy](/adr/adr-024) - **Accepted**
...
- [ADR-025: Container Plugin Model](/adr/adr-025) - **Accepted**
...
- [ADR-026: Distroless Container Images](/adr/adr-026) - **Accepted**
...
- [ADR-027: Admin API via gRPC](/adr/adr-027) - **Accepted**
  - Separate admin service on port 8981
  - Config, session, namespace, and backend management
  - RBAC and audit logging

- [ADR-028: Admin UI with FastAPI and gRPC-Web](/adr/adr-028) - **Accepted**
...
- [ADR-040: Go Binary for Admin CLI (prismctl)](/adr/adr-040) - **Accepted**
...
- [ADR-045: prismctl Stack Management Subcommand](/adr/adr-045) - **Accepted**
...
- [ADR-029: Protocol Recording with Protobuf Tagging](/adr/adr-029) - **Accepted**
  - Custom protobuf options for protocol recording
  - Sampling and queryable storage
  - Interceptor-based recording

- [ADR-030: Schema Recording with Protobuf Tagging](/adr/adr-030) - **Accepted**
...
- [ADR-041: Graph Database Backend Support](/adr/adr-041) - **Accepted**
  - Unified Graph Data Abstraction Layer
  - Comparison rubric: Neptune, Neo4j, ArangoDB, JanusGraph, DGraph
  - Backend selection guidance

- [ADR-042: AWS SQS Queue Backend Plugin](/adr/adr-042) - **Accepted**
  - Standard and FIFO queue support
  - Dead letter queue integration
  - Batch operations for cost optimization

- [ADR-043: Plugin Capability Discovery System](/adr/adr-043) - **Accepted**
...
- [ADR-044: TinkerPop/Gremlin Generic Plugin](/adr/adr-044) - **Accepted**
