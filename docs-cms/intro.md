...
**Start with**: [Why Rust?](/adr/adr-001-rust-for-proxy) | [Client Configuration](/adr/adr-002-client-configuration-protobuf)
...
**Start with**: [Architecture](/rfc/rfc-001-prism-architecture) | [Namespace Configuration](/rfc/rfc-027) | [Layered Patterns](/rfc/rfc-014-layered-data-access-patterns)
