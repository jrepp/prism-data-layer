module github.com/jrepp/prism-data-layer/patterns/keyvalue/cmd/keyvalue-runner

go 1.24.0

require (
	github.com/jrepp/prism-data-layer/patterns/keyvalue v0.0.0
...
replace github.com/jrepp/prism-data-layer/patterns/keyvalue => ../..
