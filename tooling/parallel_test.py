...
TEST_SUITES = [
    ...
    TestSuite(
        name="proxy-unit",
        command="cd proxy && cargo test --lib",
    ...
    TestSuite(
        name="core-unit",
        command="cd patterns/core && go test -v -cover ./...",
    ...
    TestSuite(
        name="memstore-unit",
        command="cd patterns/memstore && go test -v -cover ./...",
    ...
    TestSuite(
        name="redis-unit",
        command="cd patterns/redis && go test -v -cover ./...",
    ...
    TestSuite(
        name="nats-unit",
        command="cd patterns/nats && go test -v -cover ./...",
    ...
    TestSuite(
        name="lint-rust",
        command="cd proxy && cargo clippy -- -D warnings",
    ...
    TestSuite(
        ...
        command="cd patterns/memstore && go vet ./...",
    ...
    TestSuite(
        name="lint-go-redis",
        command="cd patterns/redis && go vet ./...",
    ...
    TestSuite(
        name="lint-go-nats",
        command="cd patterns/nats && go vet ./...",
    ...
    TestSuite(
        name="lint-go-core",
        command="cd patterns/core && go vet ./...",
