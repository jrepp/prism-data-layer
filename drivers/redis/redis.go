...
// Metadata returns information about which backend interfaces this driver implements.
// Redis is one of the most versatile backends, implementing 16 interfaces across 6 data models.
// This metadata is used for pattern slot matching at configuration time (MEMO-006).
func (r *RedisPattern) Metadata() *core.BackendInterfaceMetadata {
	return &core.BackendInterfaceMetadata{
		...
		Interfaces: []core.BackendInterface{
			// KeyValue interfaces (5 of 6) - missing only CAS
			core.InterfaceKeyValueBasic,         // SET, GET, DEL, EXISTS
			core.InterfaceKeyValueScan,          // SCAN, KEYS
			core.InterfaceKeyValueTTL,           // EXPIRE, TTL, PERSIST
			core.InterfaceKeyValueTransactional, // MULTI/EXEC transactions
			core.InterfaceKeyValueBatch,         // MGET, MSET, MDEL

			// PubSub interfaces (2 of 5) - fire-and-forget messaging
			core.InterfacePubSubBasic,     // PUBLISH, SUBSCRIBE, UNSUBSCRIBE
			core.InterfacePubSubWildcards, // Pattern subscriptions (*)

			// Stream interfaces (4 of 5) - Redis Streams
			core.InterfaceStreamBasic,          // XADD, XREAD, XINFO
			core.InterfaceStreamConsumerGroups, // XGROUP, XREADGROUP, XACK
			core.InterfaceStreamReplay,         // XREAD with offset
			core.InterfaceStreamRetention,      // MAXLEN, XTRIM

			// List interfaces (4 of 4) - complete list support
			core.InterfaceListBasic,    // LPUSH, RPUSH, LPOP, RPOP
			core.InterfaceListIndexing, // LINDEX, LSET, LINSERT, LREM
			core.InterfaceListRange,    // LRANGE, LTRIM
			core.InterfaceListBlocking, // BLPOP, BRPOP

			// Set interfaces (4 of 4) - complete set support
			core.InterfaceSetBasic,       // SADD, SREM, SISMEMBER, SMEMBERS
			core.InterfaceSetOperations,  // SUNION, SINTER, SDIFF
			core.InterfaceSetCardinality, // SCARD
			core.InterfaceSetRandom,      // SRANDMEMBER, SPOP

			// SortedSet interfaces (5 of 5) - complete sorted set support
			core.InterfaceSortedSetBasic,      // ZADD, ZREM, ZSCORE
			core.InterfaceSortedSetRange,      // ZRANGE, ZRANGEBYSCORE
			core.InterfaceSortedSetRank,       // ZRANK, ZREVRANK
			core.InterfaceSortedSetOperations, // ZUNION, ZINTER
			core.InterfaceSortedSetLex,        // ZRANGEBYLEX

			// Total: 24 interfaces across 6 data models
		},
		Description:            "In-memory data structure store with persistence, replication, and cluster support",
