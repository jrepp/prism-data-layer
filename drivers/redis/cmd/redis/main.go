...
import (
	...
	"github.com/jrepp/prism-data-layer/drivers/redis"
)

// main is the entrypoint for the redis backend driver.
//
...
//
// The backend driver (redis.New()) should not connect to Redis until
// Initialize() or Start() lifecycle methods are called.
func main() {
