...
│   ├── CHANGELOG.md       # Recent documentation changes
...
### 📚 Documentation Authority: `./docs-cms/`

**IMPORTANT**: ALL documentation lives in `./docs-cms/` as the single source of truth.

- **Source files**: All markdown/MDX files in `docs-cms/` (version controlled)
- **Build output**: `docs/` directory (gitignored, generated by Docusaurus)
- **Configuration**: `docusaurus/` directory (site config, not documentation content)
- **NO subdirectories**: There is no `docusaurus/docs/` - everything is in `docs-cms/`

**Structure**:
- `docs-cms/intro.md` - Documentation landing page
- `docs-cms/CHANGELOG.md` - Recent changes log
